...
host Redis `7.4.2` build needed for `redis-module/vaptr.so`. The replay
entrypoints now live together under `python/kernmlops/replay/`, and
[`replay.md`](replay.md) shows the current capture, breakpoint, and replay
commands.
