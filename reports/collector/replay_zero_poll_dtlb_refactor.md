...
Refactored replay into `python/kernmlops/data_collection/replay/` and replaced
...
1. Moved the replay implementation into:
   - `python/kernmlops/data_collection/replay/replay_trace.py`
   - `python/kernmlops/data_collection/replay/hardware_collectors.py`
   - `python/kernmlops/data_collection/replay/__init__.py`
2. Left `python/kernmlops/data_collection/replay_trace.py` as a compatibility
   shim so the older script path still works.
...
- the compatibility shim keeps the old script path usable during migration
