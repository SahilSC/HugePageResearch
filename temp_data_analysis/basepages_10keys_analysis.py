...
def _build_dashboard_template() -> str:
    """Return a self-contained dashboard HTML template for preview data."""
...
<title>Base-Pages 10-Key Dashboard</title>
<style>
  body {
...
<body>
<main>
  <h1>Base-Pages 10-Key Dashboard</h1>
  <p>Focused dashboard for the new base-pages rerun.</p>
  <p>
    This preview renders the runtime-only artifact
